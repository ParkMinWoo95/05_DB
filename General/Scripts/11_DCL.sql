...
GRANT CREATE SESSION TO TEST10_USER;
--> 연결 확인됨
...
/* TEST00_USER에게 테이블 생성 공간 할당 */
ALTER USER TEST10_USER
DEFAULT TABLESPACE USERS
QUOTA 10M ON USERS;

/* 다시 TEST10_USER 계정 접속 후 테이블 생성 */
CREATE TABLE TEST_TABLE(
	TEST_NO NUMBER PRIMARY KEY,
	TEST_COL NUMBER VARCHAR(20)
);
...
/* [객체 권한 부여 방법]
 * - GRANT 객체 권한 ON 객체명 ON 사용자명;
 */
GRANT SELECT ON EMPLOYEE
TO TEST00_USER;

/* TEST10_USER 계정 접속 */
-- KH계쩡의 EMPLOYEE 조회 시도
SELECT *
FROM KH10_PMW.EMPLOYEE;
